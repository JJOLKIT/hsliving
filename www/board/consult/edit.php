				...
				<table class="write">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="name" id="name" class="max200" value="<?=$data['name']?>"/></td>
                        </tr>
                        <tr>
                            <th>연락처 <span class="required">*<span>필수입력</span></span></th>
                            <td><input type="tel" class="max300" name="cell" id="cell" value="<?=$data['cell']?>" maxlength="15" onkeyup="isNumberOrHyphen(this);cvtPhoneNumber(this);" placeholder="숫자만 입력해주세요."/></td>
                        </tr>
                        <tr>
