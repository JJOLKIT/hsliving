				...
				<div class="wr_box">
					...
					<table class="row_line">
						...
						<tr>
							...
							<td>
								<p class="calendar">
									<input type="text" name="registdate" id="registdate"  value="<?=date("Y-m-d H:i:s")?>" class="dateTime" />
				...
				<div class="wr_box">
					...
					<table>
						...
						<tr>
							<th>노출여부</th>
							<td>
								<input type="radio" name="main" id="main1"  value="1" checked/>
								<label for="main1">노출</label>&emsp;
								<input type="radio" name="main" id="main2"  value="0" />
