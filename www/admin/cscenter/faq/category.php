...
$rowPageCount = $faq->getCategoryCount($_REQUEST);
...
function goEdit(no, name) {
	...
	location.href="process.php?cmd=editCategory&no="+no+"&name="+tName;
}
</script>
</head>
...
<!-- s:warp -->
	<div class="contWrap">
				...
				<table class="searchTable">
					...
					<tbody>				
						<tr>
							<th>카테고리명</th>
							<td>
								<input type="text" name="name" id="wri_name"/>
			...
			<div class="wr_box">
				...
				<table>
					...
					<tr>
						<th>카테고리명</th>
						<td>
							<input type="text" name="name<?=$i?>" id="name<?=$i?>"  value="<?=$row[name]?>" />
						</td>
						<td>
		...
		<div class="btnSet clear">
			<a href="index.php" class="btn hoverbg">자주하는질문 목록</a>
		</div>
		<!-- //btnSet -->
	</div>
	<!-- //contents -->
