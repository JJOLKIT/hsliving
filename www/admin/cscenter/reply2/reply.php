			...
			<div class="wr_box">
				...
				<table>
					...
					<tr>
						...
						<th>작성자</th>
						<td>
							<input type="text" name="name" id="name"  value="<?=escape_html($data['name']) ?>" class="wid200"/>
						</td>
					</tr>
					<tr>
						<th>연락처</th>
						<td><input type="text" name="cell" id="cell" value="<?=escape_html($data['cell'])?>" class="wid200"/>
						<th>이메일</th>
						<td><input type="text" name="email" id="email" value="<?=escape_html($data['email'])?>" class="wid200"/> </td>
					</tr>
					<!--
					<tr>
						<th>노출설정</th>
						<td colspan="3">
							<input type="checkbox" name="newicon" value="1" <?=getChecked(1, $data['newicon']) ?>/> 새글 (New 아이콘 노출) <span class="h_line"></span> 
			...
			<div class="wr_box">
				...
				<table>
					...
					<tr>
						<th>제목</th>
						<td>
							<input type="text" name="title" id="title"  value="Re: <?=escape_html($data['title']) ?>" />
						</td>
					</tr>
					<tr>
						<th>내용</th>
