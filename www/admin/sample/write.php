...
<script src="/admin/js/jodit.js"></script>
-->
...
<script src="/ckeditor/myConfig.js"></script>
<script>
...
<div id="warp">
	<div class="contents">
		<h2 class="fl_l"><?=$pageTitle ?> 글쓰기</h2>
				...
				<table>
					...
					<tr>
						...
						<td>
							...
							<textarea id="editor" name="contents" style="min-height:400px;">asdf</textarea>
							*/
							?>
