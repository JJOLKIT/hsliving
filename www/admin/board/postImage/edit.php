...
<div id="wrapper">
	<div class="contWrap">
				...
				<table>
					...
					<tr>
						...
						<? } ?>
							...
							<input  type="file" name="imagename" id="imagename" onchange="getThumbnailPrivew(this,$('#thumb_img'))"/>
						</td>
					</tr>
					<tr>
						<th>첨부파일</th>
		...
		<!-- //write -->
		<div class="btnSet">
			<a href="<?=$post->getQueryString('index.php', 0, $_REQUEST)?>" class="btn">목록</a>
