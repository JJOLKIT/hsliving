...
<script>
	...
	// 초기 세팅
	function checkCalSet(num){
		var placeChk = 0;
		placeChk = $("input[name='place']:checked").val();

		var obj = $("#datapicker"+num);
										...
										<tr>
											...
											<td>
												<div class="radio_box rd_st1">
													...
													?>
													<p>
														<input type="radio" name="place" id="pl0<?=$i?>" value="<?=$i?>" onclick="checkCal2(this);" <?=getChecked($i,$data['place'])?>>
										...
										<tr>
											...
											<td>
												<div class="cal_wrap">
													<?for($i=0; $i<count($rdata); $i++){?>
													<div class="wraps">
														<div class="cals sel_st"><input type="text" placeholder="이용 일시" name="rdates[]" id="datapicker<?=$i?>" readonly autocomplete="off" onchange="checkCal(this);" value="<?=$rdata[$i]['rdate']?>"/></div>
														<div class="time_sel sel_st">
															<input type="hidden" id="rtime<?=$i?>" value="<?=$rdata[$i]['rtime']?>"/>
															<div class="select" name="rtimes[]" id="rtimes<?=$i?>">
															</div>
														</div>
														<div class="hour_sel sel_st">
															<input type="hidden" id="rhour<?=$i?>" value="<?=$rdata[$i]['rhour']?>"/>
															<div class="select" name="rhours[]" id="rhours<?=$i?>">
															</div>
														</div>
														<div class="btns">
															<a href="javascript:;" class="add_btn" onclick="addOption('cal_wrap');"></a>
															<a href="javascript:;" class="rmv_btn" onclick="delOption(this);setPrice();"></a>
														</div>
													</div>
													<?}?>
												</div>
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td>
												<div class="radio_box rd_st1">
													<?for($i = 1; $i<= 2; $i++){?>
													<p>
														<input type="radio" name="gb" id="if0<?=$i?>" value="<?=$i?>" onclick="setGb(this);" <?=getChecked($i,$data['gb'])?>>
										...
										<tr class="gb1_tr">
											...
											<td>
												<div class="md_ip"><input type="text" name="company" value="<?=$data['company']?>"/></div>
											</td>
										</tr>
										<tr>
											<th>
										...
										<tr class="gb2_tr" style="display:none;">
											<th><p>생년월일</p></th>
											<td>
												<div class="md_ip"><input type="text" name="birthday" value="<?=$data['birthday']?>" placeholder="생년월일 8자리" maxlength = "8" onkeyup="onlyNumber(this);"/><div>
											</td>
										</tr>
										<tr class="gb1_tr">
											<th>
											...
											<td>
												<div class="md_ip"><input type="text" name="reg_number" placeholder="숫자만 입력해주세요" onkeyup="onlyNumber(this);" value="<?=$data['reg_number']?>"/></div>
											</td>
										</tr>
										<tr>
											<th>
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td>
												<div class="radio_box rd_st2">
													...
													?>
													<p>
														<input type="radio" name="purpose" id="pr0<?=$i?>" value="<?=$i?>" <?=getChecked($i,$data['purpose'])?>>
										...
										<tr>
											...
											<td>
												<div class="fl_ip"><input type="text" name="title" value="<?=$data['title']?>"/></div>
											</td>
										</tr>
										<tr>
											<th>
											...
											<td>
												<div class="fl_ip"><input type="text" name="contents" value="<?=$data['contents']?>"/></div>
											</td>
										</tr>
										<tr>
											<th>
											...
											<td>
												<div class="sm_ip"><input type="text" name="amount" placeholder="숫자만 입력해주세요" onkeyup="onlyNumber(this);" maxlength="2" value="<?=$data['amount']?>"/></div>
											</td>
										</tr>
									</tbody>
								</table>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<p class="yl"><b id="price_html"><?=$data['price']?></b><span>원</span></p>
											</td>
										</tr>
										<tr>
											<th>
